export const CATEGORIES = {
  dev:     { label: 'Dev',     bg: 'bg-dev',     bgLight: 'bg-blue-50',    text: 'text-blue-700' },
  sante:   { label: 'Sante',   bg: 'bg-sante',   bgLight: 'bg-emerald-50', text: 'text-emerald-700' },
  menage:  { label: 'Menage',  bg: 'bg-menage',  bgLight: 'bg-amber-50',   text: 'text-amber-700' },
